...
MODEL                   = rov_kinematics_level3
MODULES                 = rov_kinematics_level3_acc.c rov_kinematics_level3_acc_data.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/rov_kinematics_level3_acc.mexmaca64
MAKEFILE                = rov_kinematics_level3.mk
MATLAB_ROOT             = /Applications/MATLAB_R2024b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2024b.app
START_DIR               = /Users/eirikvarnes/code/rov-control-project
S_FUNCTIONS_LIB         = 
NUMST                   = 9
NCSTATES                = 56
COMPUTER                = MACA64
...
MODELLIB                  = rov_kinematics_level3_acc.mexmaca64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/rov_kinematics_level3 \
...
rov_kinematics_level3_acc.o : $(START_DIR)/slprj/accel/rov_kinematics_level3/rov_kinematics_level3_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/rov_kinematics_level3/rov_kinematics_level3_acc.c

rov_kinematics_level3_acc_data.o : $(START_DIR)/slprj/accel/rov_kinematics_level3/rov_kinematics_level3_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/rov_kinematics_level3/rov_kinematics_level3_acc_data.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/rov_kinematics_level3/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/rov_kinematics_level3/rt_nonfinite.c
